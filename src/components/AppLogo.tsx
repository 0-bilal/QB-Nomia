  ...
  return (
    <div className="flex flex-col items-center">
      <div className="mb-1.5 flex items-center gap-2.5">
        <div
          className="flex h-8.5 w-8.5 items-center justify-center rounded-[10px] shadow-[0_6px_16px_-4px_rgba(0,226,138,0.55)]"
          style={{ background: 'linear-gradient(150deg, var(--color-accent), var(--color-accent-b))', width: 34, height: 34 }}
        >
          <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="#04140D" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
